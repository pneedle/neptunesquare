...
echo ".word1 { font-size: 14px; color: #1A446C; vertical-align:top; }";
echo ".word2 {font-size: 14px; color: #1A446C; vertical-align:top; }";
echo ".aspects {margin: 0 0; }";
echo "</style>";
...
$q = array("","","","","","","","","","","");
$string = file_get_html('http://www.ephemeris.com/ephemeris.php')->plaintext;
...
// replace SGR and PSC with SAG and PIS
	...
	echo "<table class=\"aspects\">
		<tr>
			<td width=\"6%\"><img src=\"sites/default/files/glyphs/".$p[$i].".jpg\" height=\"25\" width=\"25\"></td>
			<td class=\"word1\" width=\"25%\">".$P[$i]."</td>
			<td width=\"6%\"><img src=\"sites/default/files/glyphs/".$sign.".jpg\" height=\"25\" width=\"25\"></td>
			<td class=\"word2\" width=\"25%\">".$sign." ".$degree."&#176;".$minute."'</td>
			<td width=\"38%\" bgcolor=\"#FFFFFF\"></td>
		</tr></table>";

// set variable for daily_daily (nid = 977)
$nid = 977;
